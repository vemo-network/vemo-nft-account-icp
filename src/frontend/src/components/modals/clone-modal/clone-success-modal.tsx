...
export function CreateTBAModalSuccess({ data }: CreateWalletDataProps) {
  ...
  const { project, tokenId, account, chainId } = data;
    ...
    <>
      ...
      >
        ...
        <p className="flex flex-col gap-[24px] mb-10">
          Now you can connect with D-app using this wallet.
        </p>
        <div className="p-3 bg-grey-200 rounded-[8px] mb-10">
          ...
          <div className="flex gap-[24px] items-center mt-4">
            <RenderChainIcon chainId={chainId ?? project.chainId} width={22} height={22} />
